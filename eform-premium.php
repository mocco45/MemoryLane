        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="event-premium.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>My Event</a>
            ...
            Swal.fire({
                ...
                <?php } ?>
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post" action="db/eformpro-premium.php" enctype="multipart/form-data">
                                 <div class="row">
                                    <div class="col">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="eloc" id="floatingInput">
                                <label for="floatingInput">Location Link</label>
                            </div><div class="form-floating mb-3">
                                <input type="text" class="form-control" name="message" id="floatingInput">
                                <label for="floatingInput">Invitation Message</label>
                            </div>
                            <div class="form-floating mb-3">
