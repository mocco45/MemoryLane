...
?>
        ...
        <head>
            ...
            <!-- Google Fonts -->
            <link href="https://fonts.googleapis.com/css?family=Playfair+Display:500i,700i,900i|Nunito:700,900|Raleway:250,400,500" rel="stylesheet">
                            ...
                            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="carousel-item active">
                                        <div class="carousel-background"><img src="../uploads-premium/<?php echo $row['cover_img'] ?>" alt="" width="100%"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="card-title pt-3">
                                        <h3>Mr <?php echo $row['gfname'] ?></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
                                    <img src="../uploads-premium/<?php echo $row['groom_img']?>" class="card-img-right" alt="" width="220" height="250">
                                </div>
                ...
                <div class="container h-50">
                        <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <img src="../uploads-premium/<?php echo $row['bride_img']?>" class="card-img-right" alt="" width="220" height="250">
                                </div>
                            </div>
                        </div>
                   </div>
