                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Today Events</p>
                                
                                <h6 class="mb-0">
                                    <?php 
                                foreach($conn->query("SELECT COUNT(*) FROM event WHERE userid=$uid") as $row) {echo $row['COUNT(*)'];}?>
                                </h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Total Registerd</p>
                                <h6 class="mb-0">
                                    <?php 
                                foreach($conn->query("SELECT COUNT(*) FROM rsvp WHERE eid=$uid") as $row) {echo $row['COUNT(*)'];}?>
                                </h6>
                            </div>
                        </div>
                    </div>
