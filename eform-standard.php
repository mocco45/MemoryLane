        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="event-standard.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>My Event</a>
            ...
            Swal.fire({
                ...
                <?php } ?>
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post" action="db/eformpro-standard.php" enctype="multipart/form-data">
                                 <div class="row">
                                    <div class="col">
