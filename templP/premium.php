                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-6 text-right">
                                ...
                                <h4>Groom Profile.</h4>
                                <p>Edson Philip Ufinyu here, and I'm from Dodoma. I come from a Christian background and firmly believe that Jesus Christ is my Lord and Savior. Kigogo is my maternal tongue. My mother is a stay-at-home mom, and my father has a small company. At the College of Business Administration, I earned a bachelor's degree in business administration (BBA) with a focus on finance and marketing. I live in Dar es Salaam and have a job right now. I like to watch sports, read books, and pray.</p>
                                <img src="img/brid1.png" class="rounded float-right" alt="...">
                            </div>
                            <div class="col-6 text-left">
                                <h4>Bride Profile.</h4>
                                <p>Hello, I'm Berry Calist Masele . Berry  is a kind, understanding, and cheerful individual. As one of the best in my field, I attribute my success to my grounded nature. I have a Master's degree in Civil Engineering. Currently, I live in Dar es Salaam. It is my optimistic personality that is adored by all. Currently, I am employed by the government. Traveling, exploring opportunities, and reading are some of my favourite things.</p>
                                <img src="img/grom1.png" class="rounded float-left" alt="...">
                            </div>
                        </div>
